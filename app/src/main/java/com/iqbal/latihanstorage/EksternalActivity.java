package com.iqbal.latihanstorage;
...
public class EksternalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String FILENAME = "namafileeks.txt";
    ...
    void buatFile() {
        ...
        Log.d("PESAN", String.valueOf(Environment.getExternalStorageDirectory()));
        Log.d("PESAN",Environment.getExternalStorageDirectory().getAbsolutePath());
